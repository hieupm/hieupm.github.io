...
Dans ce post je rassemble les instructions CLI commandes pour chacun des services AWS.

# Pré-requis

Pour utiliser AWS CLI, il faut au préalable **l'installer** et de la **paramétrer**.
